...
const getAllowedOrigins = () => {
  ...
  const prodDomain = Deno.env.get('ALLOWED_DOMAIN') || 'https://alchemist-satellite-tracker.vercel.app';
  const customDomains = [
    'https://alchemistsatmap.com',
    'https://satellite-tracker.com',
    'https://www.alchemistsatmap.com'
  ];
  return [devOrigin, prodDomain, ...customDomains];
};
